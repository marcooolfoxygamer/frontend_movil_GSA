...
const BienvenidaAprendiz = ({navigation}) => {
    return (
      <SafeAreaView>
        {/* Barra de navegación */}
        ...
        <View style={styles.contenedor_vista}>
            <View style={styles.contenedor_encabezado}>
              <Text style={styles.titulo}>¡Bienvenid@ a su cuenta aprendiz!</Text>
            ...
            <View style={styles.contenido}>
              <Image
                source={require('../../assets/images/Aprendiz.jpg')}
                style={styles.imagen}
              />
...
export default BienvenidaAprendiz